...
const TeacherClassDetails = () => {
    ...
    console.log("TeacherClassDetails - Class ID:", classID);
    console.log("TeacherClassDetails - Subject ID:", subjectID);
                        ...
                        <Paper sx={{ width: '100%', overflow: 'hidden' }}>
                            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', p: 2 }}>
                                ...
                                <Button 
                                    variant="contained" 
                                    color="primary" 
                                    onClick={() => navigate(`/Teacher/class/bulk-attendance/${classID}/${subjectID}`)}
                                    sx={{
