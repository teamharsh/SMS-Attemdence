...
import { Box, Button, Collapse, Table, TableBody, TableHead, Typography, IconButton } from '@mui/material';
                ...
                <div>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                        <IconButton onClick={() => navigate(-1)}>
                            <KeyboardArrowDown />Back
                        </IconButton>
                        <Button 
                            variant="outlined"
                            color="primary"
                            onClick={() => navigate(`/Teacher/class/bulk-attendance/${userDetails.sclassName?._id}/${teachSubjectID}`)}
                        >
                            Class Attendance
                        </Button>
                    </Box>
